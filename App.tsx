        ...
        {showDisclaimer && (appState === 'SETUP' || appState === 'PORTFOLIO_VIEW') && (
            <ConnectionRequest 
                onProceed={() => {
                    ...
                    // UX UPDATE: Go to Portfolio View first before Landing
                ...
                <div className="w-full h-full relative z-10 flex flex-col items-center justify-between py-4 px-3 md:py-8 md:px-8 animate-in fade-in duration-700 overflow-y-auto">
                     ...
                     <div className="absolute bottom-4 left-0 w-full px-6 flex justify-between items-center z-40 font-mono text-[10px] md:text-xs pointer-events-none">
                         <button 
                            ...
                            className="pointer-events-auto flex items-center gap-2 text-[var(--text-secondary)] hover:text-[var(--accent-ruby-500)] transition-colors group"
                         >
                         ...
                         <button 
                            ...
                            className="pointer-events-auto flex items-center gap-2 text-[var(--text-secondary)] hover:text-[var(--accent-topaz-500)] transition-colors group"
                         >
